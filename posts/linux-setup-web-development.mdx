...
- RedmiBook Pro 15S (Ryzen 5600H、16G RAM、512G SSD)
...
- [AppIndicator and KStatusNotifierItem Support](AppIndicator and KStatusNotifierItem Support) - 让 Gnome 支持系统托盘
